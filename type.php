...
<div class="form-container">
        <div class="form-box">
            <h2 class="text-center">บันทึกประเภทสินค้า</h2>
            <form action="backend/save_type.php" method="post" name="form1" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">ชื่อประเภทสินค้า</label>
                    <input type="text" class="form-control" id="t_name" name="t_name" aria-describedby="emailHelp" maxlength="100" require>
                    <div id="emailHelp" class="form-text">กรุณาพิมพ์ชื่อประเภทสินค้าลงในช่องว่าง</div>
                </div>
